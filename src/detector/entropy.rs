...
mod tests {
    ...
    fn test_high_entropy_api_key() {
        ...
        let entropy = calculate_shannon_entropy(text);
        assert!(entropy > 4.5, "Expected high entropy for API key, got {}", entropy);
    }
    ...
    fn test_high_entropy_random() {
        ...
        let entropy = calculate_shannon_entropy(text);
        assert!(entropy > 4.5, "Expected high entropy for random string, got {}", entropy);
    }
    ...
    fn test_real_openai_key_pattern() {
        ...
        let entropy = calculate_shannon_entropy(text);
        assert!(entropy > 4.0, "OpenAI key should have entropy > 4.0, got {}", entropy);
    }
    ...
    fn test_real_github_token_pattern() {
        ...
        let entropy = calculate_shannon_entropy(text);
        assert!(entropy > 4.0, "GitHub token should have entropy > 4.0, got {}", entropy);
    }
    ...
    fn test_aws_secret_pattern() {
        ...
        let entropy = calculate_shannon_entropy(text);
        assert!(entropy > 4.5, "AWS secret should have entropy > 4.5, got {}", entropy);
    }
}
